  ...
  return (
    <dialog id="login_modal" className="modal">
      <div className="modal-box px-12">
        ...
        <h3 className="font-bold text-lg">Log in to Memo</h3>
        <button
          className="mt-4 w-full py-2 bg-blue-500 hover:bg-blue-600 dark:bg-primary text-white rounded-md mb-4 flex items-center justify-center"
          onClick={() => {
            const width = 600;
            const height = 400;
